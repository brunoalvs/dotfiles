...
# function to prompt if user wants to install homebrew ('yes', y and 'sim' are valid answers)
...
prompt_install_homebrew # call function to prompt user to install homebrew
